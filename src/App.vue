  ...
  <header id="title">
   ...
   <div class="entry-body" >
    ...
    <div id="entry-footers">
      <img id="STZH" src="./assets/STZH_SEB_Logo.jpg" alt="Opportunity Logo">
      <img id="SAG" src="./assets/SAG_Logo_De.jpg" alt="Stiftung SAG Logo">
      <img id="Opportunity" src="./assets/Opportunity.jpg" alt=" Stadt Zürich logo">
    </div> 
  </div>
</template>
<script>
